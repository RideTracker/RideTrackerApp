...
import { View, Image, TextInput, ActivityIndicator, Text, Alert, KeyboardAvoidingView, LayoutRectangle, ScrollView, Dimensions, Animated, Easing, TouchableOpacity, Keyboard } from "react-native";
        ...
        if(submitting) {
            registerUser(client, firstname, lastname, email, password).then((response) => {
                ...
                if(response.token) {
                    ...
                    router.push("/avatar-editor/?from_registration=true");
                }
    ...
    return (
        <View style={{ flex: 1, backgroundColor: theme.background }}>
            ...
            <View style={{
                ...
                <View pointerEvents={(submitting)?("none"):("auto")} style={{ flex: 1 }}>
                    <Animated.View style={{
                        flexGrow: 1,
