...
export default class Button extends ThemedComponent {
    ...
    render() { 
        return (
            <TouchableOpacity style={[ style.sheet, (this.props.branded != undefined && style.sheet.branded), (this.props.transparent != undefined && style.sheet.transparent), (this.props.opaque != undefined && style.sheet.opaque), (this.props.confirm != undefined && style.sheet.confirm), (this.props.margin != undefined && style.sheet.noMargin), (this.props.style != undefined && this.props.style) ]} onPress={() => this.onPress()}>
