    ...
    return (
        <View style={{ gap: 20, padding: 20 }}>
            <View style={{ flexDirection: "row" }}>
                <View style={{ width: "50%" }}>
                    <Text style={{ textAlign: "center", fontSize: 28, fontWeight: "500" }}>7.3 km</Text>
                    <Text style={{ textAlign: "center", fontSize: 16 }}>distance</Text>
                </View>
                
                <View style={{ width: "50%" }}>
                    <Text style={{ textAlign: "center", fontSize: 28, fontWeight: "500" }}>23.7 km/h</Text>
            ...
            <View style={{ flexDirection: "row" }}>
                <View style={{ width: "50%" }}>
                    <Text style={{ textAlign: "center", fontSize: 28, fontWeight: "500" }}>33 m</Text>
                    <Text style={{ textAlign: "center", fontSize: 16 }}>elevation</Text>
                </View>
                
                <View style={{ width: "50%" }}>
                    <Text style={{ textAlign: "center", fontSize: 28, fontWeight: "500" }}>38.8 km/h</Text>
